   ...
   <div class="pages">
      ...
      <main class="main">
         ...
         <nav class="nav-pages container">
            ...
            <a href="/pages/product-catalog.php" class="nav-pages__link nav-pages__link_active">
               Каталог
            </a>
         </nav>
         <!-- nav-pages -->
         ...
         <!-- banner -->
         <article class="banner banner_product-catalog">
            <div class="banner__container container">
               <h2 class="banner__big-title big-title">
                  Каталог товаров
               </h2>
            </div>
         </article>
            ...
            <div class="popular-categories__container container">
               <div class="popular-categories__row">
                  <a href="#" class="popular-categories__link">
                     ...
                     <img src="/img/popular-categories/electric-scooter.png" alt="Робот-пылесоссы"
