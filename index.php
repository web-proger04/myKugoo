<?php
$dbCard = new PDO("mysql:host=localhost;dbname=mykugoo", "root", "");
$dbQuestion = new PDO("mysql:host=localhost;dbname=questions", "root", "");
$dbPopularProducts = new PDO("mysql:host=localhost;dbname=popular-products", "root", "");
$dbBlogArticles = new PDO("mysql:host=localhost;dbname=blog-articles", "root", "");

// карточки товара
$infoCard = [];

if ($query = $dbCard->query("SELECT * FROM `info-card`")) {
$infoCard = $query->fetchAll(PDO::FETCH_ASSOC);
} else {
print_r($dbCard->errorInfo());
}

// частые вопросы
$infoQuestions = [];

if ($query = $dbQuestion->query("SELECT * FROM `answers`")) {
$infoQuestions = $query->fetchAll(PDO::FETCH_ASSOC);
} else {
print_r($dbQuestion->errorInfo());
}

// популярные товары
$infoPopularProducts = [];

if ($query = $dbPopularProducts->query("SELECT * FROM `popular-product`")) {
$infoPopularProducts = $query->fetchAll(PDO::FETCH_ASSOC);
} else {
print_r($dbPopularProducts->errorInfo());
}

// статьи в блоге
$infoBlogArticles = [];

if ($query = $dbBlogArticles->query("SELECT * FROM `article`")) {
$infoBlogArticles = $query->fetchAll(PDO::FETCH_ASSOC);
} else {
print_r($dbBlogArticles->errorInfo());
}
                  ...
                  <div class="middle-header__catalog-modal catalog-modal">
                     <nav class="catalog-modal__menu">
                        <ul class="catalog-modal__list">
                           <li class="catalog-modal__item">
                              <a href="/pages/electric-scooters.html" class="catalog-modal__link">
                           ...
                           <li class="catalog-modal__item electric-bicycles">
                              <a href="#" class="catalog-modal__link">
                                 <svg class="catalog-modal__icon" width="16" height="17" viewBox="0 0 16 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                           ...
                           <li class="catalog-modal__item robot-cleaner">
                              <a href="#" class="catalog-modal__link">
                                 <svg class="catalog-modal__icon" width="16" height="17" viewBox="0 0 16 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                           ...
                           <li class="catalog-modal__item scales">
                              <a href="#" class="catalog-modal__link">
                                 <svg class="catalog-modal__icon" width="16" height="17" viewBox="0 0 16 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                     ...
                     <ul class="catalog-modal__info-modal-catalog info-modal-catalog">
      ...
      <main class="main">
         ...
         <section class="scooters-banner">
            <div class="scooters-banner__container container">
               <div class="scooters-banner__offer">
                  ...
                  <a href="/pages/product-catalog.html" class="scooters-banner__button button">
                     Перейти в католог
                  </a>
               </div>
            ...
            <div class="electric-scooters__container container">
               ...
               <div class="electric-scooters__product-card product-card">
                  ...
                  <article class="product-card__content">
                     ...
                     <a href="<?= $data['link'] ?>" class="product-card__image">
                        <img src="<?= $data['image']?>" alt="Самокат">
                     </a>
                     <div class="product-card__info">
                        <a href="<?= $data['link'] ?>" class="product-card__title">
                           <?= $data['title'] ?>
                        </a>
                        ...
                        <div class="product-card__footer">
                           ...
                           <div class="product-card__icons">
                              <button type="button" data-cart
                                 class="product-card__icon product-card__icon_basket product-card__icon_border">
                              ...
                              <button type="button" class="product-card__icon product-card__icon_border">
                                 <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                     ...
                     <a href="<?= $data['link'] ?>" class="product-card__button button_purple">
                        Купить в 1 клик
                     </a>
                  </article>
                  <?php endforeach; ?>
         ...
         <section class="popular-categories">
            <div class="popular-categories__container container">
               ...
               <div class="popular-categories__row">
                  <a href="/pages/electric-scooters.html" class="popular-categories__link">
         ...
         <article class="blog-articles">
            <div class="blog-articles__container container">
               ...
               <div class="blog-articles__slider-blog slider-blog swiper">
                  ...
                  <?php foreach ($infoBlogArticles as $data): ?>
                     <article class="slider-blog__slide swiper-slide">
                        <a href="<?= $data['link'] ?>" class="slider-blog__image">
                           <img src="<?= $data['image'] ?>" alt="Photo">
                        </a>
                        <div class="slider-blog__info">
                           <a href="<?= $data['link'] ?>" class="slider-blog__title">
                              <?= $data['title'] ?>
                           </a>
         ...
         <article class="what">
            <div class="what__container container">
               ...
               <?php foreach ($infoQuestions as $data): ?>
         ...
         <section class="often-buy">
            <div class="often-buy__container container">
               ...
               <?php foreach ($infoPopularProducts as $data): ?>
                  <article class="product-card__content">
                     <div class="product-card__header">
                        <span class="product-card__subtitle product-card__subtitle_hit">
                           <?= $data['hype']?>
                  ...
                  <li class="footer__item-footer item-footer">
                     ...
                     <ul class="item-footer__list">
                        <li class="item-footer__link">
                           <a class="underline" href="/pages/electric-scooters.html">
                              Электросамокаты
                           </a>
                        </li>
                        <li class="item-footer__link">
